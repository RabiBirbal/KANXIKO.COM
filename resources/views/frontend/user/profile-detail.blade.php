...
<div class="container">
	<div class="row">
        <div class="col-md-12 text-right">
                <a href="{{ url('profile/edit/'.Crypt::encryptString($sellerInfo->seller_id)) }}"><button class="btn btn-success">Edit Profile</button></a>
        </div>
    </div>
	...
	<div class="col-lg-12 well">
		<div class="row">
			<form action="" method="post">
				...
				<input type="hidden" name="seller_id" value="{{ $seller['id'] }}" class="form-control">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-6 form-group">
							<label>First Name</label>
							<input type="text" name="fname" value="{{ $seller['first_name'] }}" placeholder="Enter First Name Here.." class="form-control" required readonly>
						</div>
						<div class="col-sm-6 form-group">
							<label>Last Name</label>
							<input type="text" name="lname" value="{{ $seller['last_name'] }}" placeholder="Enter Last Name Here.." class="form-control" required readonly>
						</div>
					</div>					
					...
					<div class="row">
						<div class="col-sm-4 form-group">
							<label>City</label>
							<input type="text" name="city" value="{{ $sellerInfo['city'] }}" placeholder="Enter City Name Here.." class="form-control" required readonly> 
						</div>	
						<div class="col-sm-4 form-group">
							<label>Province</label>
							<br>
							<select class="select1 form-control" name="province" disabled>
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<input type="text" name="company_name" value="{{ $sellerInfo['company_name'] }}" placeholder="Enter Designation Here.." class="form-control" required readonly>
							</div>		
							<div class="col-sm-6 form-group">
								<label>Company address</label>
								<input type="text" name="company_address" value="{{ $sellerInfo['company_address'] }}" placeholder="Enter Company Name Here.." class="form-control" required readonly>
							</div>	
						</div>						
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Landline number (if required)</label>
								<input type="text" name="landline" value="{{ $sellerInfo['landline'] }}" placeholder="Landline number" class="form-control" readonly>
							</div>		
							<div class="col-sm-6 form-group">
								<label>Mobile Number</label>
								<input type="text" name="mobile" value="{{ $seller['mobile'] }}" placeholder="Mobile Number" class="form-control" required readonly>
							</div>	
						</div>			
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Primary Email</label>
								<input type="text" name="email" value="{{ $seller['email'] }}" placeholder="Primary Email" class="form-control" readonly >
							</div>		
							<div class="col-sm-6 form-group">
								<label>Secondary Email (if required)</label>
								<input type="text" name="secondary_email" value="{{ $sellerInfo['secondary_email'] }}" placeholder="Secondary Email" class="form-control" readonly>
							</div>	
						</div>
						{{-- <div class="row">
							<div class="col-sm-6 form-group">
