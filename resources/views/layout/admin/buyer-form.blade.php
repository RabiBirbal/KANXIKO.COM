<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 ">
        <input type="text" id="customer_name" name="customer_name" required="required" class="form-control" autofocus>
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 ">
        <input type="email" id="customer_email" name="customer_email" required="required" class="form-control" autofocus>
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 ">
        <input type="text" id="customer_contact" name="customer_contact" required="required" class="form-control" autofocus>
    </div>
</div>
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 ">
        <input type="text" id="customer_address" name="customer_address" required="required" class="form-control" autofocus>
    </div>
</div>
<div class="item form-group">
