	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6 text-light dashboard">
				<a href="{{ route('buy-leads') }}" class="text-light"><h2>Dashboard</h2></a>
			</div>
    ...
    <div class="container padding-bottom-3x mb-2 mt-5">
	    <div class="row justify-content-center">
	        <div class="col-lg-8 col-md-10">
	            <form action="{{ route('post-change-password') }}" method="post" class="card mt-4">
                    @csrf
                    <input type="hidden" name="id" value="{{ $seller['id'] }}">
	                <div class="card-body">
	                    <div class="form-group">
                            <input class="form-control" type="email" name="email" id="email-for-pass" placeholder="Enter Your Email Address" value="{{ $seller['email'] }}" required="" readonly>
                        </div>
                        <div class="form-group">
