                      ...
                      <div class="col-sm-12">
						<div class="row">
							<div class="col-md-12 text-right">
								<a href="{{ url('seller/edit/'.Crypt::encryptString($sellerInfo->seller_id)) }}"><button class="btn btn-success">Edit Profile</button></a>
							</div>
						</div>
                        <form action="" method="post">
							@csrf
							<input type="hidden" name="sellerinfo_id" value="{{ $sellerInfo['id'] }}" class="form-control" readonly>
							<input type="hidden" name="seller_id" value="{{ $sellerInfo['seller_id'] }}" class="form-control" readonly>
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-6 form-group">
										<label>First Name</label>
										<input type="text" name="fname" value="{{ $sellerInfo['first_name'] }}" placeholder="Enter First Name Here.." class="form-control" required readonly>
									</div>
									<div class="col-sm-6 form-group">
								...
								<div class="row">
									...
									<div class="col-sm-6 form-group">
										...
										<input type="text" name="mobile" value="{{ $sellerInfo['mobile'] }}" placeholder="Mobile Number" class="form-control" required readonly>
									</div>	
								</div>			
								<div class="row">
									<div class="col-sm-6 form-group">
