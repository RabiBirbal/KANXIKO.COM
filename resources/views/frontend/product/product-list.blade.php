...
<div class="col-md-12">
    <a href="{{ route('seller-product-add') }}" class="btn btn-success">Add Product</a>
  </div>
		...
		<table id="datatable" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody id="myTable">
              ...
              <tr>
                <td>{{ $n }}</td>
                <td>{{ $data->name }}</td>
                <td class="text-center"><img src="{{ asset('upload/images/'.$data['product_image']) }}" alt="product image" height="100px"></td>
                <td>{{ $data->category }}</td>
                {{-- <td>{{ $data->subcategory }}</td> --}}
                <td>
                    <a href="{{ route('seller-product-edit',$data['id']) }}" class="btn btn-primary">Edit</a>
