                    ...
                    <div class="form-row">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          <input id="refer" name="refer" placeholder="Referal Code" class="form-control" value="{{ $refercode }}" type="text" readonly>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                              <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleCheck1"> I accept all the <a href="{{ route('register-terms-condition') }}">terms and conditions</a></label>
                              </div>
                              </div>
