                ...
                <div class="row">
                                      ...
                                      <tbody id="myTable">
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="{{ url('9851240938/'.$data['name'].'/subcategory/details') }}" class="btn btn-success">Add Sub-Category</a>
                                          </td>
                                        </tr>
                                        @endforeach
                                      </tbody>
                    ...
                    <div class="col-md-12 col-sm-12 ">
                      <div class="x_panel">
                          ...
                          <div class="x_content">
                            <form action="{{ route('add_category') }}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left was-validated">
                              @csrf
